...
stations.forEach((station) => {
  client.hset('stationslongtoshort', station.stationName, station.crsCode, (err, replies) => {
    if (err) console.log(err)
  })
})

stations.forEach((station) => {
  client.hset('stationsshorttolong', station.crsCode, station.stationName, (err, replies) => {
    if (err) console.log(err)
  })
})
